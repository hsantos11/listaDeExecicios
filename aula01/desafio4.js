...
para o contrário.
*/
var isTruthy = function(abc){ return !! abc;};
...
*/
carro.obterMarcaModelo=function(){ return 'esse carrcarro é um ' + carro.obterMarca() + ''+ carro.obterModelo();};
...
*/
carro.adicionarPessoas= function( numeroPessoas){ var totalPessoas = carro.quantidadePessoas + numeroPessoas; if ( carro.quantidadePessoas === carro.assentos  && totalPessoas >= carro.assentos){return "o carro já está lotado ";} if (totalPessoas > carro.assentos){var quantasPessoasCabem = carro.assentos - carro.quantidadePessoas; var pluralOuSingular= quantasPessoasCabem ===1? " pessoa" : " pessoas"; return "só cabem mais "+ quantasPessoasCabem +  pluralOuSingular +"  !";} carro.quantidadePessoas += numeroPessoas;  return "Já temos "+carro.quantidadePessoas+"  pessoas no carro!";};
...
carro.adicionarPessoas(4) // 'Já temos 4  pessoas no carro!'

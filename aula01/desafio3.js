...
*/
pessoa.parar= function(metros){pessoa.caminhouQuantosMetros+= metros;
...
*/
pessoa.nomeCompleto() // 'Olá! Meu nome é herberth santos!'

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.MostrarIdade() //'Olá, eu tenho38anos!'
...
retornada)
*/
pessoa.MostrarIdade() //'Olá, eu tenho  41anos!'
